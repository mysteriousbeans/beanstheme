...
?>
<div class="sb_instagram_header <?php echo esc_attr( $size_class ); ?>" style="padding-bottom: 0;">
    <a href="https://www.instagram.com/<?php echo urlencode( $username ); ?>" target="_blank" rel="noopener" title="@<?php echo esc_attr( $username ); ?> on instagram" class="sbi_header_link">
        <div class="sbi_header_text<?php echo esc_attr( $bio_class ); ?>">
            <h3 <?php echo $header_text_color_style; ?>><i class="fab fa-instagram"></i> @mysteriousbeans</h3>
